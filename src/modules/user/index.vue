 ...
 * @LastEditTime: 2023-12-09 12:10:13
 * @FilePath: \oms-platform-app\src\modules\user\index.vue
 * @Description:
-->
<template>
  <basic-layout show-tab-bar>
    <div class="user-page no-nav pb-[60px]">
      <!-- 用户信息 -->
        ...
        <a href="/service/feedback/recode" class="flex flex-nowrap items-center justify-between px-4 py-0 h-[54px]">
          ...
          <div class="arrow">
            <img
              ...
              :style="{ width: isH5 ? '' : '12px', height: isH5 ? '' : '24px' }"
...
.user-page {
  background: url(https://m.tesoon.com/assets/img/index_bg.246025bf.png) no-repeat top;
  background-size: 100%;
